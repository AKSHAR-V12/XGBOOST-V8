...
# -------------------------
MODEL_PATH = Path(os.getenv("MODEL_PATH", "models/muscle_growth_model.pkl"))
FEATURES_PATH = Path(os.getenv("FEATURES_PATH", "feature_names.json"))
...
if not FEATURES_PATH.exists():
    ...
    raise FileNotFoundError(f"Feature names file missing: {FEATURES_PATH}")
